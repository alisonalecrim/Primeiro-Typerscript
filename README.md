# Comandos para setup do ambiente - Typescript
==============================================

### Projeto Node

1. Abrir a pasta do projeto com o terminal;
2. Inserir **npm init**;
3. Confirmar as configurações;

### Typescript

1. **npm install-g typescript** (se possível);
2. **npm install typescript**;
3. **npm install lite-server**;
4. **Add script no package.json - "start": "lite-server"**;
5. **npm start inicia o servidor**;
6. **tsc --init gera arquivo de configuração**;
7. **Add script "watch": "tsc --watch" - gera a compilação**;
8. **Rodar compilação com npm run watch**;

## Mais sobre o Typescript https://www.typescriptlang.org/tsconfig
